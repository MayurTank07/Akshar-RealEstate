...
const localityDefinitions = [
  ...
  ["ahmedabad", "New C.G. Road", "Ahmedabad", "A north Ahmedabad address around the Chandkheda side for buyers comparing residential options near established local services.", ["Chandkheda", "Motera", "Tragad", "Zundal"], ["New C.G. Road", "Chandkheda side", "North Ahmedabad"], "New C.G. Road connects with Chandkheda, Motera, Tragad and Gandhinagar-side movement.", ["new-c-g-road"]],
