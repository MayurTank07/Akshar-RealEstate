...
export const staffApi = {
  ...
  formDrafts: (params = {}) => request(`/admin/form-drafts${toQueryString(params)}`, { authRequired: true }),
  formDraft: (params = {}) => request(`/admin/form-drafts/current${toQueryString(params)}`, { authRequired: true }),
  saveFormDraft: (payload) => request("/admin/form-drafts/current", { method: "PUT", body: JSON.stringify(payload), authRequired: true }),
  deleteFormDraft: (params = {}) => request(`/admin/form-drafts/current${toQueryString(params)}`, { method: "DELETE", authRequired: true }),
  ...
  deleteBlog: (id) => request(`/admin/blogs/${id}`, { method: "DELETE", authRequired: true }),
